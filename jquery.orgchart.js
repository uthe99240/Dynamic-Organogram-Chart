    ...
    function Node(data){
        ...
        this.formatNode = function(opts){
            ...
            if(typeof data.src !== 'undefined'){
                ...
                srcString = self.data.src;
                imgString = "<img style='height:100px; width:100px; border-radius:50%' src='" + srcString + "'>";
            }
            if(typeof data.name !== 'undefined'){
                nameString = '<p>'+self.data.name+'</p>';
            }
            // return "<div class='node' node-id='"+this.data.id+"'>"+nameString+descString+"</div>";
            return "<div class='node' node-id='"+this.data.id+"'>"+imgString+nameString+"</div>";
        }
    }
